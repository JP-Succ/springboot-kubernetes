package org.jsuccurro.springcloud.msvc.usuarios.controllers;


import org.jsuccurro.springcloud.msvc.usuarios.models.entity.Usuario;
import org.jsuccurro.springcloud.msvc.usuarios.services.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<?> crear(@Valid @RequestBody Usuario usuario, BindingResult result){
        ...
        if(!usuario.getEmail().isEmpty() &&
                service.existePorEmail(usuario.getEmail())){
